...
namespace Internal
{
    ...
    public class ConditionalFieldAttributeDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            _toShow = ConditionalFieldUtility.PropertyIsVisible(_conditionalToTarget[property], _attribute.Inverse,
        ...
        private void GetPropertyDrawerType(SerializedProperty property)
        {
            ...
            {
                _genericAttribute =
                    (PropertyAttribute) fieldInfo.GetCustomAttributes(typeof(PropertyAttribute), false)[1];
    ...
    public static class ConditionalFieldUtility
    {
        ...
        public static bool BehaviourPropertyIsVisible(MonoBehaviour behaviour, string propertyName,
            ConditionalFieldAttribute appliedAttribute)
        {
            ...
            return ConditionalFieldUtility.PropertyIsVisible(targetProperty, appliedAttribute.Inverse,
